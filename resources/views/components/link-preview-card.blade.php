<div id="link-preview-card" data-url="{{ $url }}" class="mx-auto mt-2 min-w-full group/preview" data-navigate-ignore="true">
    @if ($data->has('html'))
    ...
    @elseif($data->has('image'))
        ...
        <a href="{{ $url }}" target="_blank" rel="noopener noreferrer">
            ...
            dark:border-0 rounded-lg dark:group-hover/preview:border-0 overflow-hidden">
                <img src="{{ $data->get('image') }}" alt="{{ $data->get('title') ?? $url }}"
                ...
                <div
                    ...
                    <h3
                        class="text-sm font-semibold truncate text-slate-500/90 dark:text-white/90
                    ">
